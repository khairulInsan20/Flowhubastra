...
export const completeRabRealization = (id) => api.post(`/rab-submissions/${id}/realization-complete`).then((response) => response.data);
export const actionRabRealization = (id, payload) => api.post(`/rab-submissions/${id}/realization-action`, payload).then((response) => response.data);
