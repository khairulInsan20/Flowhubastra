...
- Formulir Flowhub kini menyiapkan integrasi AI masa depan tanpa menjalankannya: PIC mengisi prompt/preferensi per tahap, tanggal tiket pulang-pergi, tanggal hotel, dan rute transport fleksibel (asal, tujuan, tanggal) yang dapat ditambah sebagai baris baru.
- Bukti harga saat ini menyimpan metadata nama berkas untuk diteruskan ke Sekretaris, Koordinator, SPV, dan Manager; penyimpanan berkas privat ditunda sesuai pilihan pengguna.
- Travel Assistant direvisi menjadi wizard visual Flowhub dengan urutan Berangkat → Pulang → Hotel → Transport → Review. Transport memakai isian bebas Asal, Tujuan, dan Tanggal; PIC menambahkan rute lalu memilih moda serta harga. Review menjadi halaman terpisah yang mewajibkan bukti dan memungkinkan harga/pilihan ditinjau ulang per tiket berangkat, tiket pulang, hotel, serta setiap rute transport.
